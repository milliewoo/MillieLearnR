...
1. fork the repo for this website and follow instructions on read me to get set up. [https://github.com/milliewoo/MillieLearnR](https://github.com/milliewoo/MillieLearnR)

2. Blog/journal what you are doing in R, by editing the Journal.Rmd. See the [Journal page](https://milliewoo.github.io/MillieLearnR/Journal.html) for an example of what to do to get started learning R.
